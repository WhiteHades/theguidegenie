...
useSeoMeta({ title: "guide profile" });
...
const onSubmit = handleSubmit(async (values) => {
  try {
    ...
    setFieldError("name", error.message || "failed to update profile");
...
<template>
  <div class="container max-w-2xl py-8">
    <div class="mb-8">
      <h1 class="font-display text-3xl font-bold">guide profile</h1>
      <p class="mt-2 text-muted-foreground">update the public details tied to your account</p>
    </div>
